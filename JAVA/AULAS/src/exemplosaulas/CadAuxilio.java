...
public class CadAuxilio {
	...
	public static void main(String[] args) {
		...
		if (chefaFamilia && naoOutroAuxilio) {
			...
			System.out.printf("Ola Sr%c. você irá receber de auxilio R$ %.2f, mais R$ %.2f do(s) filho(s) gerando um total de R$ %.2f.",pronome,AUXILIO,(VALORFILHO*filhos),(AUXILIO+(VALORFILHO*filhos)))			;
		}
		else {
